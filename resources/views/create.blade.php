            ...
            <div class="card-body">
                ...
                <form action="{{route('employee.store')}}" class="was-validated" method="POST" novalidate>
                    ...
                    <div class="form-group has-validation">
                        ...
                        <input type="date" name="joining_date" id="joining_date" value="{{old('joining_date')}}" class="form-control {{$errors->has('joining_date')?'is-invalid':''}}" required>
                    ...
                    <div class="form-group has-validation">
                        ...
                        <input type="number" name="salary" id="joining_salary" value="{{old('salary')}}" class="form-control {{$errors->has('salary')?'is-invalid':''}}" required>
                    ...
                    <div class="form-group has-validation">
                        ...
                        <input type="checkbox" name="is_active" id="is_active" class="form-control {{$errors->has('is_active')?'is-invalid':''}}" value="1" required {{old('is_active')=='1'?'checked':''}}>
