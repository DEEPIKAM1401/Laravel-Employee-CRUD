            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(route('employee.update', $employee->id)); ?>" class="was-validated" method="POST">
                    ...
                    <div class="form-group has-validation">
                        ...
                        <input type="checkbox" name="is_active" id="is_active" class="form-control <?php echo e($errors->has('is_active')?'is-invalid':''); ?>" value="1"  <?php echo e($employee->is_active=='1'?'checked':''); ?> required>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\New folder\example-app\resources\views/edit.blade.php ENDPATH**/ ?>