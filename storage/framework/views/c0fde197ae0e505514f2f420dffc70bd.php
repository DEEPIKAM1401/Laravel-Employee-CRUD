...
<?php $__env->startSection('content'); ?>
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="joining_salary">Phone</label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\New folder\example-app\resources\views/show.blade.php ENDPATH**/ ?>